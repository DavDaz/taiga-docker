...
metadata:
  ...
  scope: [root]
  auto_invoke:
    - "Modifying config.py or urls_railway.py"
    - "Adding or changing Django middleware"
    - "Configuring Django settings (email, static, media, database)"
    - "Customizing Django admin (grappelli, base_site.html)"
    - "Debugging Django errors or 500s in taiga-back"
    - "Adding Django management commands via SSH"
    - "Configuring WhiteNoise or static file serving"
---
