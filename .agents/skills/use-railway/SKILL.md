...
metadata:
  ...
  scope: [root]
  auto_invoke:
    - "Deploying any service to Railway"
    - "Restarting gateway after deploy"
    - "Setting or listing Railway variables"
    - "Checking service logs or status"
    - "Creating environments or domains"
    - "Running Django management commands via SSH"
    - "Troubleshooting 504s, build failures, or DNS issues"
---
